...
description: Read-only benchmarking test for measuring file format token efficiency. Reads a single file completely and returns confirmation. Establishes baseline token cost per format.
tools: Read
model: inherit
maxTurns: 4
---
