...
class ReportGenerator {
    ...
    generateSummaryTLDRFormatRanking(sortedAggregated) {
        ...
        this.line();
        this.table(['↑ Total Opt', '↑ Total Man', '↓ Used Tokens Opt', '↓ Used Tokens Man', '↑ Wasted Tokens Opt', '↑ Wasted Tokens Man', '↓ Acc (%) Opt', '↓ Acc (%) Man', '↓ Wtd Acc (%) Opt', '↓ Wtd Acc (%) Man', '↓ Eff Score Opt', '↓ Eff Score Man', '↓ Wtd Eff Score Opt', '↓ Wtd Eff Score Man'], rows);
        this.line();
    ...
    generateAppendices() {
        ...
        this.table(['Format', 'Records', 'Variant', 'Accuracy (%)', 'Weighted Accuracy (%)', 'Delta (%)'], accRows);
