...
class ReportGenerator {
    ...
    generateResults() {
        ...
        this.line();
        this.heading(4, '2.1.3 Conclussion');
        this.line();
        ...
        this.table(['Format', 'Variant', 'Read Tokens', 'Output Tokens', 'Total', 'Tokens/Char', 'Info/Token', 'Token/Answer', 'Raw Acc (%)', 'Wtd Acc (%)', 'Used Tokens', 'Wasted Tokens', 'Eff Score', 'Wtd Eff Score'], rows);
        ...
        this.table(['Format', 'Tokens Man', 'Tokens Opt', 'Diff', 'Diff (%)', 'Acc Man (%)', 'Acc Opt (%)', 'Diff (%)', 'Wtd Acc Man (%)', 'Wtd Acc Opt (%)', 'Diff (%)', 'Eff Man (%)', 'Eff Opt (%)', 'Diff (%)'], mandOptFormatDeltaRows);
        // 2.4 Performance
        ...
        this.table(['Format', 'Variant', 'Total Tokens', 'Useful Tokens', 'Wasted Tokens', 'Raw Acc (%)', 'Wtd Acc (%)', 'Eff Score', 'Wtd Eff Score',], effTokenRows);
